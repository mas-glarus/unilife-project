				...
				<div className="select-container">
					<div className="bedroom-container">
						<label for="select-bedroom">
							Any bedroom:
							<Select id="select-bedroom" placeholder="Any bedroom" />
						</label>
					</div>
					<div className="bathroom-container">
						<label for="select-bathroom">
							Any bathroom:
							<Select id="select-bathroom" placeholder="Any bathroom" />
						</label>
					</div>
					<div className="price-container">
						<label for="select-price">
							Any price:
							<Select id="select-price" placeholder="Any price" />
						</label>
					</div>
					<div className="type-container">
						<label for="select-type">
							Any type:
							<Select id="select-type" placeholder="Any type" />
						</label>
					</div>
				</div>
			</div>
